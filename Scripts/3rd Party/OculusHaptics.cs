...
public class OculusHaptics : MonoBehaviour
{
	...
	//IMPORTANT: This required the OVRManager class to be present in the scene, probably on the camera

	[SerializeField]
	OVRInput.Controller controllerMask = OVRInput.Controller.RTouch;
